...
def update_ableton_knob(knob_cc, knob_val):
  status_byte = 0xB0 + ARTURIA_CHANNEL - 1
  loopbe_out.send_message([status_byte, knob_cc, knob_val])
...
def all_notes_off():
  for note_val in held_notes:
    status_byte = 0x80 + ARTURIA_CHANNEL - 1
    loopbe_out.send_message([status_byte, note_val, 0])
